(module
  ...
  (import "env" "is_account" (func $22 (param i64) (result i32)))
  ...
  (import "env" "send_deferred" (func $28 (param i32 i64 i32 i32 i32)))
  ...
  (data $17 (i32.const 192)
    "write\00")
  (data $17 (i32.const 8608)
