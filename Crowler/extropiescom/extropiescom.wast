(module
  ...
  (data $13 (i32.const 112)
    "Sabre--WooKong and Wookong solo, TideBit; BladeX--Wookong Bio, e"
    "veritoken, TOKEX\00")
  (data $13 (i32.const 208)
    "Sabre, hardware wallet like ledger, with AS658 from synochip and"
    " 128x64 LCD. Firmware developed by Xueping Hou and Hongtao Xing."
    "  BladeX, powerful hardware wallet in credit card size, with K6 "
    "from TMC and PixelAuth, 51822 from Nordic, ET510E from Egistec, "
    "EINK from WF, firmware developed by Kefei Wei and Hongtao Xing.\00")
  (data $13 (i32.const 528)
    "Kefei Wei, Liang Li, Hongtao Xing, Yanxiang Hua, Xueping Hou, Mi"
    "nchao Xi, Anjie Li, Deliang Li, Wei Peng\00")
  (data $13 (i32.const 640)
    "read\00")
  (data $13 (i32.const 656)
    "extropies is a company who make secure devices for blockchain. h"
    "i \00")
  (data $13 (i32.const 9120)
