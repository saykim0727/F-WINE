(module
  ...
  (import "env" "cancel_deferred" (func $18 (param i32) (result i32)))
  ...
  (import "env" "send_deferred" (func $25 (param i32 i64 i32 i32 i32)))
