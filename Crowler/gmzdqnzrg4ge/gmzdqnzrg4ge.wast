(module
  ...
  (import "env" "action_data_size" (func $12  (result i32)))
  (import "env" "current_time" (func $13  (result i64)))
  (import "env" "eosio_assert" (func $14 (param i32 i32)))
  (import "env" "read_action_data" (func $15 (param i32 i32) (result i32)))
  (import "env" "require_auth2" (func $16 (param i64 i64)))
  ...
  (export "_ZN5eosio5token6createEv" (func $22))
