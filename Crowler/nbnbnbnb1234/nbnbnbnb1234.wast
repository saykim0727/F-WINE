(module
  ...
  (global $44 i32 (i32.const 19201))
  (global $45 i32 (i32.const 19201))
  (elem $41 (i32.const 1)
    $104 $107 $109 $111 $102)
  ...
  (data $42 (i32.const 17293)
    "bet not found\00")
  (data $42 (i32.const 17307)
    "object passed to iterator_to is not in multi_index\00")
  (data $42 (i32.const 17358)
    "error reading iterator\00")
  (data $42 (i32.const 17381)
    "read\00")
  (data $42 (i32.const 17386)
    "fund unlock error\00")
  (data $42 (i32.const 17404)
    "cannot create objects in table of another contract\00")
  (data $42 (i32.const 17455)
    "write\00")
  (data $42 (i32.const 17461)
    "attempt to subtract asset with different symbol\00")
  (data $42 (i32.const 17509)
    "subtraction underflow\00")
  (data $42 (i32.const 17531)
    "subtraction overflow\00")
  (data $42 (i32.const 17552)
    "cannot pass end iterator to modify\00")
  (data $42 (i32.const 17587)
    "object passed to modify is not in multi_index\00")
  (data $42 (i32.const 17633)
    "cannot modify objects in table of another contract\00")
  (data $42 (i32.const 17684)
    "updater cannot change primary key when modifying an object\00")
  (data $42 (i32.const 17743)
    "object passed to erase is not in multi_index\00")
  (data $42 (i32.const 17788)
    "cannot erase objects in table of another contract\00")
  (data $42 (i32.const 17838)
    "attempt to remove object that was not in multi_index\00")
  (data $42 (i32.const 17891)
    "magnitude of asset amount must be less than 2^62\00")
  (data $42 (i32.const 17940)
    "invalid symbol name\00")
  (data $42 (i32.const 17960)
    "bet id:\00")
  (data $42 (i32.const 17968)
    " player: \00")
  (data $42 (i32.const 17978)
    " winner! - eoswin.one\00")
  (data $42 (i32.const 18000)
    "TF\00\00")
  (data $42 (i32.const 18004)
    ".12345abcdefghijklmnopqrstuvwxyz\00")
  (data $42 (i32.const 18037)
    "eoswinonewww\00")
  (data $42 (i32.const 18050)
    "unable to find key\00")
  (data $42 (i32.const 18069)
    " airdrop ! - eoswin.one\00")
  (data $42 (i32.const 18093)
    "divide by zero\00")
  (data $42 (i32.const 18108)
    "signed division overflow\00")
  (data $42 (i32.const 18133)
    " referral reward! - eoswin.one\00")
  (data $42 (i32.const 18164)
    " dividend pool\00")
  (data $42 (i32.const 18179)
    "cannot pass end iterator to erase\00")
  (data $42 (i32.const 18213)
    "cannot increment end iterator\00")
  (data $42 (i32.const 18243)
    "invalid memo\00")
  (data $42 (i32.const 18256)
    "no roll under\00")
  (data $42 (i32.const 18270)
    "no seed hash\00")
  (data $42 (i32.const 18283)
    "no user seed hash\00")
  (data $42 (i32.const 18301)
    "no expiration\00")
  (data $42 (i32.const 18315)
    "no referrer\00")
  (data $42 (i32.const 18327)
    "no signature\00")
  (data $42 (i32.const 18340)
    "only EOS token allowed\00")
  (data $42 (i32.const 18363)
    "quantity invalid\00")
  (data $42 (i32.const 18380)
    "transfer quantity must be greater than 0.1\00")
  (data $42 (i32.const 18423)
    "roll under overflow, must be greater than 2 and less than 96\00")
  (data $42 (i32.const 18484)
    "offered overflow, expected earning is greater than the maximum b"
    "onus\00")
  (data $42 (i32.const 18553)
    "comparison of assets with different symbols is not allowed\00")
  (data $42 (i32.const 18612)
    "fund pool overdraw\00")
  (data $42 (i32.const 18631)
    "seed hash expired\00")
  (data $42 (i32.const 18649)
    "hash duplicate\00")
  (data $42 (i32.const 18664)
    "-\00")
  (data $42 (i32.const 18666)
    "altadfe*&^%$$##@@$%^&*\00")
  (data $42 (i32.const 18689)
    " \00")
  (data $42 (i32.const 18691)
    "next primary key in table is at autoincrement limit\00")
  (data $42 (i32.const 18743)
    "cannot decrement end iterator when the table is empty\00")
  (data $42 (i32.const 18797)
    "cannot decrement iterator at beginning of table\00")
  (data $42 (i32.const 18845)
    "attempt to add asset with different symbol\00")
  (data $42 (i32.const 18888)
    "addition underflow\00")
  (data $42 (i32.const 18907)
    "addition overflow\00")
  (data $42 (i32.const 18925)
    "get\00")
  (data $42 (i32.const 18944)
