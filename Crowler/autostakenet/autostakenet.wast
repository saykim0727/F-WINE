(module
  ...
  (import "env" "is_account" (func $19 (param i64) (result i32)))
  ...
  (export "_ZN12autostakenet10ontransferEyyN5eosio14extended_assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE" (func $31))
  ...
  (data $14 (i32.const 48)
    "Only core token is accepted\00")
  (data $14 (i32.const 80)
    "The recepient account does not exist\00")
