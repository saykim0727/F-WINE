(module
  ...
  (import "env" "printn" (func $23 (param i64)))
  (import "env" "printi" (func $24 (param i64)))
  ...
  (global $14 i32 (i32.const 16700))
  (global $15 i32 (i32.const 16700))
  (elem $11 (i32.const 1)
    $30)
  (data $12 (i32.const 8192)
    "sendtras, \00")
  (data $12 (i32.const 8203)
