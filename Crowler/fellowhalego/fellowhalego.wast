(module
  ...
  (import "env" "eosio_exit" (func $33 (param i32)))
  ...
  (export "_ZN10fellowhale10onTransferERKN5eosio8currency8transferE" (func $46))
  (export "_ZN10fellowhale3endEv" (func $61))
  (export "_ZN10fellowhale4initEy" (func $63))
  (export "_ZN10fellowhale5applyEyy" (func $65))
  ...
  (data $22 (i32.const 16)
    "This contract cannot become a Fellowhale himself\00")
  (data $22 (i32.const 80)
    "Message is too long (should be less than 100 characters)\00")
  ...
  (data $22 (i32.const 352)
    "Oh no! You were swallowed by the new Whale -- (Always yours, Fel"
    "lowhale)\00")
    ...
    block $block
      block $block1
        ...
        block $block9
          ...
          get_local $13
          f64.convert_u/i64
          f64.const 0x1.f34e47ef130a9p-1
          f64.mul
          i64.trunc_s/f64
          tee_local $3
