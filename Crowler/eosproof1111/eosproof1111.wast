(module
  ...
  (import "env" "db_idx256_lowerbound" (func $28 (param i64 i64 i64 i32 i32 i32) (result i32)))
  (import "env" "db_idx256_store" (func $29 (param i64 i64 i64 i64 i32 i32) (result i32)))
  ...
  (data $20 (i32.const 144)
    "hash already exist in table\00")
