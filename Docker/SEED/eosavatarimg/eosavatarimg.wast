(module
  ...
  (data $20 (i32.const 928)
    "updated record for: \00")
  (data $20 (i32.const 960)
    "updater cannot change primary key when modifying an object\00")
  (data $20 (i32.const 9424)
