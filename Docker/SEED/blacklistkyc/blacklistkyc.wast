(module
  ...
  (global $28 i32 (i32.const 17336))
  (global $29 i32 (i32.const 17336))
  (elem $25 (i32.const 1)
    $66 $71)
  (data $26 (i32.const 8192)
    "empty user name\00")
  (data $26 (i32.const 8208)
    "name has more than 256 bytes\00malloc_from_freed was designed to o"
    "nly be called after _heap was completely allocated\00")
  (data $26 (i32.const 8323)
    "must specify a new nickname\00")
  (data $26 (i32.const 8351)
    "User is not in whitelist\00")
  (data $26 (i32.const 8376)
    "object passed to iterator_to is not in multi_index\00")
  (data $26 (i32.const 8427)
    "error reading iterator\00")
  (data $26 (i32.const 8450)
    "read\00")
  (data $26 (i32.const 8455)
    "get\00")
  (data $26 (i32.const 8459)
    "cannot create objects in table of another contract\00")
  (data $26 (i32.const 8510)
    "write\00")
  (data $26 (i32.const 8516)
    "cannot pass end iterator to modify\00")
  (data $26 (i32.const 8551)
    "object passed to modify is not in multi_index\00")
  (data $26 (i32.const 8597)
    "cannot modify objects in table of another contract\00")
  (data $26 (i32.const 8648)
    "updater cannot change primary key when modifying an object\00")
  (data $26 (i32.const 8707)
    "cannot pass end iterator to erase\00")
  (data $26 (i32.const 8741)
    "cannot increment end iterator\00")
  (data $26 (i32.const 8771)
    "object passed to erase is not in multi_index\00")
  (data $26 (i32.const 8816)
    "cannot erase objects in table of another contract\00")
  (data $26 (i32.const 8866)
