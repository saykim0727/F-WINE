(module
  ...
  (import "env" "tapos_block_num" (func $18  (result i32)))
  (import "env" "tapos_block_prefix" (func $19  (result i32)))
  (import "env" "current_time" (func $20  (result i64)))
  (import "env" "prints" (func $21 (param i32)))
  (import "env" "printi" (func $22 (param i64)))
  ...
  (import "env" "get_blockchain_parameters_packed" (func $27 (param i32 i32) (result i32)))
  ...
  (global $14 i32 (i32.const 16694))
  (global $15 i32 (i32.const 16694))
  (elem $11 (i32.const 1)
    $31)
  (data $12 (i32.const 8192)
    "%v %v %v\00")
  (data $12 (i32.const 16608)
