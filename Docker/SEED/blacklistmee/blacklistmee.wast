(module
  ...
  (import "env" "prints" (func $15 (param i32)))
  ...
  (data $11 (i32.const 112)
    "Hello Block producer, you should be blacklisting me! add actor-b"
    "lacklist to config.ini\00")
  (data $11 (i32.const 8608)
