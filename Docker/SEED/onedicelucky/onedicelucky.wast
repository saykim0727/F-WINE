(module
  ...
  (export "_ZN8dicerepo7diceico5applyEyy" (func $30))
  (export "_ZN8dicerepo7diceico16transferReceivedERKN5eosio8currency8transferEy" (func $32))
  ...
  (data $14 (i32.const 64)
    "needs to come from eosio.token\00")
  (data $14 (i32.const 96)
    "needs a memo with the name\00")
  (data $14 (i32.const 128)
    "invalid transfer\00")
  (data $14 (i32.const 160)
    "must be at least 0.1 EOS\00")
  ...
  (data $14 (i32.const 256)
    "Thank you for taking part in our ICO!\00")
